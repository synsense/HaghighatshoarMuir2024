...
class AudioRecorder:
    ...
    def record_file(self, duration: float, bits: int = 16, fs: float = 48_000, report=False):
        ...
        if output.returncode != 0:
            raise MultiMicDevKitNotFound(f"there was a problem with the board! recording failed!\n{output.stderr}")
